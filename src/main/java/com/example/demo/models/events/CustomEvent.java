...
public class CustomEvent extends Event {
    CustomEvent(String title, String content, String place, ArrayList<User> participants, int id, Task task) {
        super(title, content, place, participants, id, task);
    }
    CustomEvent(String title, String content, String place, ArrayList<User> participants, int id) {
